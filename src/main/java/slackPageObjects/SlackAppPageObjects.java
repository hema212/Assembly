...
public class SlackAppPageObjects {
	...
	By inputTextField = By.xpath("//div[@data-qa='message_input']/div[5]");
	...
	By removeVijayButton = By.xpath("//div[@class='c-virtual_list__item'][3]/div[@class='p-members_dialog_item']/button[contains(text(), 'Remove')]");
