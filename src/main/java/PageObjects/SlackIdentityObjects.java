...
public class SlackIdentityObjects {
	...
	By ConnectSlackButton = By.xpath("//div[contains(text(), 'Connect Slack')]");
	...
	By DisconnectSlackButton = By.xpath("//div[contains(text(), 'Disconnect Slack')]");
	By DisconnectSlackModalHeader = By.xpath("//div/h3");
