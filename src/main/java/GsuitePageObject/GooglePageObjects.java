...
public class GooglePageObjects {
	...
	By ConnectGSuiteButton = By.xpath("//div[contains(text(), 'Connect G Suite')]");
	...
	By DisconnectGSuiteButton = By.xpath("//div[contains(text(), 'Disconnect G Suite')]");
	By DisconnectGSuiteModalHeader = By.xpath("//div/h3");
